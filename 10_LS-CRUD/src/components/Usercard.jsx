...
const Usercard = ({ toggle, user, deleteCard, updateData }) => {
  return (
    <>
      <article className="min-h-100 group bg-white/80 rounded shadow-lg overflow-hidden w-full max-w-sm my-4">
        ...
        <div className="text-xs tracking-wider flex justify-between px-8 my-4">
          <button
            ...
            className="uppercase cursor-pointer active:scale-95 hover:text-orange-600"
          >
            Update
          </button>
          <button
            ...
            className="uppercase cursor-pointer active:scale-95 hover:text-red-600"
          >
            Delete
          </button>
        </div>
